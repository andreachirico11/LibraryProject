...
export class UserFavouritesComponent implements OnInit, OnDestroy {
  ...
  constructor(private userService: UserService, private bookService : dbService) {}
  ...
  ngOnInit() {
    ...
    this.subscription = this.userService.loggedUser.subscribe( logged =>{
      ...
      this.loggedUser.favourites = this.bookService.addCover(this.loggedUser.favourites);
      });
  }
}
